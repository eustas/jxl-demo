...
echo "${coi_serviceworker_js}" | uglifyjs -m -c > ./compressed/coi_serviceworker.js

brotli -Zfk ./compressed/coi_serviceworker.js
zopfli      ./compressed/coi_serviceworker.js
