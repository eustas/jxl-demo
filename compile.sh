...
echo "${coi_serviceworker_js}" | uglifyjs -m -c > ./compressed/coi-serviceworker.js

brotli -Zfk ./compressed/coi-serviceworker.js
zopfli      ./compressed/coi-serviceworker.js
