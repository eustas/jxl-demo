...
var JxlCodecModule = (() => {
  ...
  return (function(JxlCodecModule) {
    ...
    var buffer, HEAP8, HEAPU8, HEAP16, HEAPU16, HEAP32, HEAPU32, HEAPF32,
        HEAPF64;
    ...
    var INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 78643200;
    if (ENVIRONMENT_IS_PTHREAD) {
    ...
    var wasmBinaryFile;
    wasmBinaryFile = 'jxl_decoder.wasm';
        ...
        if (!wasmBinary &&
          ...
          return fetch(wasmBinaryFile, {credentials: 'same-origin'})
              .then(function(response) {
                ...
                return result.then(
                    receiveInstantiationResult, function(reason) {
    ...
    var PThread = {
      ...
      returnWorkerToPool: function(worker) {
        ...
        PThread.runningWorkers.splice(
            PThread.runningWorkers.indexOf(worker), 1);
        worker.pthread_ptr = 0;
        __emscripten_thread_free_data(pthread_ptr)
      },
      ...
      loadWasmModuleToWorker: function(worker, onFinishedLoading) {
        ...
        console.log('load ' + Module['mainScriptUrlOrBlob'] + ' | ' + _scriptDir);
        worker.postMessage({
          'cmd': 'load',
      ...
      allocateUnusedWorker: function() {
        var pthreadMainJs = locateFile('jxl_decoder.worker.js');
    ...
    function ___emscripten_init_main_thread_js(tb) {
      __emscripten_thread_init(
          tb, !ENVIRONMENT_IS_WORKER, 1, !ENVIRONMENT_IS_WEB);
    ...
    function pthreadCreateProxied(pthread_ptr, attr, startRoutine, arg) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(
            3, 1, pthread_ptr, attr, startRoutine, arg);
    ...
    function __emscripten_notify_task_queue(
        targetThreadId, currThreadId, mainThreadId, queue) {
    ...
    function _fd_seek(fd, offset_low, offset_high, whence, newOffset) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(
            5, 1, fd, offset_low, offset_high, whence, newOffset);
      return 70
    }
    ...
    var proxiedFunctionTable = [
      null, _proc_exit, exitOnMainThread, pthreadCreateProxied, _fd_close,
      _fd_seek, _fd_write
    ];
    var asmLibraryArg = {
    ...
    var _jxlCreateInstance = Module['_jxlCreateInstance'] = function() {
      return (_jxlCreateInstance = Module['_jxlCreateInstance'] =
                  Module['asm']['jxlCreateInstance'])
          .apply(null, arguments)
    };
    var _jxlDestroyInstance = Module['_jxlDestroyInstance'] = function() {
      return (_jxlDestroyInstance = Module['_jxlDestroyInstance'] =
                  Module['asm']['jxlDestroyInstance'])
          .apply(null, arguments)
    };
    ...
    var _jxlProcessInput = Module['_jxlProcessInput'] = function() {
      return (_jxlProcessInput = Module['_jxlProcessInput'] =
                  Module['asm']['jxlProcessInput'])
          .apply(null, arguments)
    };
    ...
    var _jxlFlush = Module['_jxlFlush'] = function() {
      return (_jxlFlush = Module['_jxlFlush'] = Module['asm']['jxlFlush'])
          .apply(null, arguments)
    };
    ...
    var __emscripten_thread_init =
        Module['__emscripten_thread_init'] = function() {
          return (__emscripten_thread_init =
    ...
    var __emscripten_thread_crashed =
        Module['__emscripten_thread_crashed'] = function() {
          return (__emscripten_thread_crashed =
                      Module['__emscripten_thread_crashed'] =
                          Module['asm']['_emscripten_thread_crashed'])
              .apply(null, arguments)
        };
    ...
    var _emscripten_dispatch_to_thread_ =
        Module['_emscripten_dispatch_to_thread_'] = function() {
          return (_emscripten_dispatch_to_thread_ =
                      Module['_emscripten_dispatch_to_thread_'] =
                          Module['asm']['emscripten_dispatch_to_thread_'])
              .apply(null, arguments)
        };
    var __emscripten_proxy_execute_task_queue =
        Module['__emscripten_proxy_execute_task_queue'] = function() {
          return (__emscripten_proxy_execute_task_queue =
                      Module['__emscripten_proxy_execute_task_queue'] =
                          Module['asm']['_emscripten_proxy_execute_task_queue'])
              .apply(null, arguments)
        };
    var __emscripten_thread_free_data =
        Module['__emscripten_thread_free_data'] = function() {
          return (__emscripten_thread_free_data =
                      Module['__emscripten_thread_free_data'] =
                          Module['asm']['_emscripten_thread_free_data'])
              .apply(null, arguments)
        };
    var __emscripten_thread_exit =
        Module['__emscripten_thread_exit'] = function() {
          return (__emscripten_thread_exit =
                      Module['__emscripten_thread_exit'] =
                          Module['asm']['_emscripten_thread_exit'])
              .apply(null, arguments)
        };
    var _setThrew = Module['_setThrew'] = function() {
      return (_setThrew = Module['_setThrew'] = Module['asm']['setThrew'])
          .apply(null, arguments)
    };
    var _saveSetjmp = Module['_saveSetjmp'] = function() {
      return (_saveSetjmp = Module['_saveSetjmp'] = Module['asm']['saveSetjmp'])
          .apply(null, arguments)
    };
    ...
    var ___cxa_is_pointer_type = Module['___cxa_is_pointer_type'] = function() {
      return (___cxa_is_pointer_type = Module['___cxa_is_pointer_type'] =
                  Module['asm']['__cxa_is_pointer_type'])
          .apply(null, arguments)
    };
    var dynCall_iiji = Module['dynCall_iiji'] = function() {
      return (dynCall_iiji = Module['dynCall_iiji'] =
                  Module['asm']['dynCall_iiji'])
          .apply(null, arguments)
    };
