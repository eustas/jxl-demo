...
(() => {
  ...
  const EMBEDDED = {
    'client_worker.js': 'let decoder=null,jobs=[];const processJobs=()=>{for(;;){let o=null;for(let e=0;e<jobs.length;++e)if(jobs[e].inputComplete){o=jobs[e],jobs[e]=jobs[jobs.length-1],jobs.pop();break}if(!o)return;console.log("CW job: "+o.uid);var t=o.input;let l=0;for(let e=0;e<t.length;e++)l+=t[e].length;var r=decoder._malloc(l);let d=0;for(let e=0;e<t.length;++e)decoder.HEAP8.set(t[e],r+d),d+=t[e].length;var e=decoder._jxlDecompress(r,l),s=(decoder._free(r),decoder.HEAP32[e>>2]),n=decoder.HEAP32[c+4>>2];const c=new Uint8Array(s),i=new Uint8Array(decoder.HEAP8.buffer);c.set(i.slice(n,n+s)),decoder._jxlCleanup(e);n={uid:o.uid,data:c};postMessage(n,[c.buffer])}},onLoadJxlModule=(onmessage=function(e){var l=e.data;if(console.log("CW received: "+l.op),"decodeJxl"===l.op){let o=null;for(let e=0;e<jobs.length;++e)if(jobs[e].uid===l.uid){o=jobs[e];break}o||(o={uid:l.uid,input:[],inputComplete:!1},jobs.push(o)),l.data?o.input.push(l.data):o.inputComplete=!0,processJobs()}},e=>{decoder=e,processJobs()}),config=(importScripts("jxl_decoder.js"),{mainScriptUrlOrBlob:"https://jxl-demo.netlify.app/jxl_decoder.js"});JxlDecoderModule(config).then(onLoadJxlModule);',
    'jxl_decoder.js': 'var JxlDecoderModule=(()=>{var je="undefined"!=typeof document&&document.currentScript?document.currentScript.src:void 0;return"undefined"!=typeof __filename&&(je=je||__filename),function(e){e=e||{},(o=o||(void 0!==e?e:{})).ready=new Promise(function(e,n){t=e,i=n});var o,t,i,n,s,r,D=Object.assign({},o),a=(e,n)=>{throw n},u="object"==typeof window,c="function"==typeof importScripts,f="object"==typeof process&&"object"==typeof process.versions&&"string"==typeof process.versions.node,w=o.ENVIRONMENT_IS_PTHREAD||!1,l="";function O(e){return o.locateFile?o.locateFile(e,l):l+e}if(f){var p,B,l=c?require("path").dirname(l)+"/":__dirname+"/";"function"==typeof require&&(p=require("fs"),B=require("path")),n=(e,n)=>(e=B.normalize(e),p.readFileSync(e,n?void 0:"utf8")),r=e=>e=(e=n(e,!0)).buffer?e:new Uint8Array(e),s=(e,t,r)=>{e=B.normalize(e),p.readFile(e,function(e,n){e?r(e):t(n.buffer)})},1<process.argv.length&&process.argv[1].replace(/\\\\/g,"/"),process.argv.slice(2),process.on("uncaughtException",function(e){if(!(e instanceof M))throw e}),process.on("unhandledRejection",function(e){throw e}),a=(e,n)=>{if(_)throw process.exitCode=e,n;n instanceof M||g("exiting due to exception: "+n),process.exit(e)},o.inspect=function(){return"[Emscripten Module object]"};let e;try{e=require("worker_threads")}catch(e){throw console.error(\'The "worker_threads" module is not supported in this node.js build - perhaps a newer version is needed?\'),e}global.Worker=e.Worker}else(u||c)&&(c?l=self.location.href:"undefined"!=typeof document&&document.currentScript&&(l=document.currentScript.src),l=0!==(l=je?je:l).indexOf("blob:")?l.substr(0,l.replace(/[?#].*/,"").lastIndexOf("/")+1):"",f||(n=e=>{var n=new XMLHttpRequest;return n.open("GET",e,!1),n.send(null),n.responseText},c&&(r=e=>{var n=new XMLHttpRequest;return n.open("GET",e,!1),n.responseType="arraybuffer",n.send(null),new Uint8Array(n.response)}),s=(e,n,t)=>{var r=new XMLHttpRequest;r.open("GET",e,!0),r.responseType="arraybuffer",r.onload=()=>{200==r.status||0==r.status&&r.response?n(r.response):t()},r.onerror=t,r.send(null)}));f&&"undefined"==typeof performance&&(global.performance=require("perf_hooks").performance);var d,m=console.log.bind(console),h=console.warn.bind(console),C=(f&&(m=e=>p.writeSync(1,e+"\\n"),h=e=>p.writeSync(2,e+"\\n")),o.print||m),g=o.printErr||h,_=(Object.assign(o,D),o.quit&&(a=o.quit),o.wasmBinary&&(d=o.wasmBinary),o.noExitRuntime||!0);"object"!=typeof WebAssembly&&k("no native wasm support detected");var y,H,F,V,v,b,X,N=!1,L="undefined"!=typeof TextDecoder?new TextDecoder("utf8"):void 0,m=(w&&(x=o.buffer),o.INITIAL_MEMORY||78643200);if(w)y=o.wasmMemory,x=o.buffer;else if(o.wasmMemory)y=o.wasmMemory;else if(!((y=new WebAssembly.Memory({initial:m/65536,maximum:m/65536,shared:!0})).buffer instanceof SharedArrayBuffer))throw g("requested a shared WebAssembly.Memory but the returned buffer is not a SharedArrayBuffer, indicating that while the browser has SharedArrayBuffer it does not have WebAssembly threads support - you may need to set a flag"),f&&g("(on node you may need: --experimental-wasm-threads --experimental-wasm-bulk-memory and also use a recent version)"),Error("bad memory");var m=(x=y?y.buffer:x).byteLength,h=x,x=h;o.HEAP8=F=new Int8Array(h),o.HEAP16=new Int16Array(h),o.HEAP32=v=new Int32Array(h),o.HEAPU8=V=new Uint8Array(h),o.HEAPU16=new Uint16Array(h),o.HEAPU32=b=new Uint32Array(h),o.HEAPF32=new Float32Array(h),o.HEAPF64=X=new Float64Array(h);var Y,J=[],Z=[],z=[];var A,S=0,G=null,T=null;function k(e){throw w?postMessage({cmd:"onAbort",arg:e}):o.onAbort&&o.onAbort(e),g(e="Aborted("+e+")"),N=!0,e=new WebAssembly.RuntimeError(e+". Build with -sASSERTIONS for more info."),i(e),e}function Q(){return A.startsWith("data:application/octet-stream;base64,")}function $(){var e=A;try{if(e==A&&d)return new Uint8Array(d);if(r)return r(e);throw"both async and sync fetching of the wasm failed"}catch(e){k(e)}}A="jxl_decoder.wasm",Q()||(A=O(A));var K={};function M(e){this.name="ExitStatus",this.message="Program terminated with exit("+e+")",this.status=e}function ee(e){(e=j.V[e])||k(),j.da(e)}function ne(e){var n=j.pa();if(!n)return 6;j.Z.push(n),(j.V[e.U]=n).U=e.U;var t={cmd:"run",start_routine:e.ta,arg:e.na,pthread_ptr:e.U};return n.Y=()=>{t.time=performance.now(),n.postMessage(t,e.va)},n.loaded&&(n.Y(),delete n.Y),0}function te(e){if(w)return I(1,1,e);_||(j.ua(),o.onExit&&o.onExit(e),N=!0),a(e,new M(e))}function re(e,n){if(!n&&w)throw ae(e),"unwind";te(e)}var j={W:[],Z:[],ga:[],V:{},$:function(){w?j.ra():j.qa()},qa:function(){for(var e=4;e--;)j.aa()},ra:function(){j.receiveObjectTransfer=j.sa,j.threadInitTLS=j.fa,j.setExitStatus=j.ea,_=!1},ea:function(){},ua:function(){for(var e of Object.values(j.V))j.da(e);for(e of j.W)e.terminate();j.W=[]},da:function(e){var n=e.U;delete j.V[n],j.W.push(e),j.Z.splice(j.Z.indexOf(e),1),e.U=0,xe(n)},sa:function(){},fa:function(){j.ga.forEach(e=>e())},ba:function(r,a){r.onmessage=e=>{var n,t=(e=e.data).cmd;r.U&&(j.oa=r.U),e.targetThread&&e.targetThread!=P()?(n=j.V[e.xa])?n.postMessage(e,e.transferList):g(\'Internal error! Worker sent a message "\'+t+\'" to target pthread \'+e.targetThread+", but that thread no longer exists!"):"processProxyingQueue"===t?fe(e.queue):"spawnThread"===t?ne(e):"cleanupThread"===t?ee(e.thread):"killThread"===t?(e=e.thread,t=j.V[e],delete j.V[e],t.terminate(),xe(e),j.Z.splice(j.Z.indexOf(t),1),t.U=0):"cancelThread"===t?j.V[e.thread].postMessage({cmd:"cancel"}):"loaded"===t?(r.loaded=!0,a&&a(r),r.Y&&(r.Y(),delete r.Y)):"print"===t?C("Thread "+e.threadId+": "+e.text):"printErr"===t?g("Thread "+e.threadId+": "+e.text):"alert"===t?alert("Thread "+e.threadId+": "+e.text):"setimmediate"===e.target?r.postMessage(e):"onAbort"===t?o.onAbort&&o.onAbort(e.arg):t&&g("worker sent an unknown command "+t),j.oa=void 0},r.onerror=e=>{throw g("worker sent an error! "+e.filename+":"+e.lineno+": "+e.message),e},f&&(r.on("message",function(e){r.onmessage({data:e})}),r.on("error",function(e){r.onerror(e)}),r.on("detachedExit",function(){})),r.postMessage({cmd:"load",urlOrBlob:o.mainScriptUrlOrBlob||je,wasmMemory:y,wasmModule:H})},aa:function(){var e=O("jxl_decoder.worker.js");j.W.push(new Worker(e))},pa:function(){return 0==j.W.length&&(j.aa(),j.ba(j.W[0])),j.W.pop()}};function E(e){for(;0<e.length;)e.shift()(o)}function ae(e){if(w)return I(2,0,e);try{re(e)}catch(e){e instanceof M||"unwind"==e||a(1,e)}}o.PThread=j,o.establishStackSpace=function(){var e=P(),n=v[e+44>>2];Te(n,n-v[e+48>>2]),q(n)};var R=[];function oe(e){var n=R[e];return n||(e>=R.length&&(R.length=e+1),R[e]=n=Y.get(e)),n}function ie(e){this.X=e-24,this.ha=function(e){b[this.X+4>>2]=e},this.ka=function(e){b[this.X+8>>2]=e},this.la=function(){v[this.X>>2]=0},this.ja=function(){F[this.X+12>>0]=0},this.ma=function(){F[this.X+13>>0]=0},this.$=function(e,n){this.ia(),this.ha(e),this.ka(n),this.la(),this.ja(),this.ma()},this.ia=function(){b[this.X+16>>2]=0}}o.invokeEntryPoint=function(e,n){e=oe(e)(n),_?j.ea(e):Ae(e)};var se;function ue(e,n,t,r){return w?I(3,1,e,n,t,r):ce(e,n,t,r)}function ce(e,n,t,r){if("undefined"==typeof SharedArrayBuffer)return g("Current environment does not support SharedArrayBuffer, pthreads are not available!"),6;var a=[];return w&&0===a.length?ue(e,n,t,r):(e={ta:t,U:e,na:r,va:a},w?(e.wa="spawnThread",postMessage(e,a),0):ne(e))}function fe(e){Atomics.store(v,e>>2,1),P()&&be(e),Atomics.compareExchange(v,e>>2,1,0)}function I(r,a){var e,n,o=arguments.length-2,i=arguments;return e=()=>{for(var e=ke(8*o),n=e>>3,t=0;t<o;t++)X[n+t]=i[2+t];return ve(r,o,e,a)},n=U(),e=e(),q(n),e}o.executeNotifiedProxyingQueue=fe;var D=f?()=>{var e=process.hrtime();return 1e3*e[0]+e[1]/1e6}:w?()=>performance.now()-o.__performance_now_clock_drift:()=>performance.now(),le=[];function pe(e){return w?I(4,1,e):52}function de(e,n,t,r,a){return w?I(5,1,e,n,t,r,a):70}var me=[null,[],[]];function he(e,n,t,r){if(w)return I(6,1,e,n,t,r);for(var a=0,o=0;o<t;o++){var i=b[n>>2],s=b[n+4>>2];n+=8;for(var u=0;u<s;u++){var c=V[i+u],f=me[e];if(0===c||10===c){for(var c=1===e?C:g,l=f,p=0,d=p+NaN,m=p;l[m]&&!(d<=m);)++m;if(16<m-p&&l.buffer&&L)l=L.decode(l.buffer instanceof SharedArrayBuffer?l.slice(p,m):l.subarray(p,m));else{for(d="";p<m;){var h,_,y=l[p++];128&y?(h=63&l[p++],192==(224&y)?d+=String.fromCharCode((31&y)<<6|h):(_=63&l[p++],(y=224==(240&y)?(15&y)<<12|h<<6|_:(7&y)<<18|h<<12|_<<6|63&l[p++])<65536?d+=String.fromCharCode(y):(y-=65536,d+=String.fromCharCode(55296|y>>10,56320|1023&y)))):d+=String.fromCharCode(y)}l=d}c(l),f.length=0}else f.push(c)}a+=s}return b[r>>2]=a,0}j.$();var W,_e=[null,te,ae,ue,pe,de,he],ye={w:function(e){return we(e+24)+24},v:function(e,n,t){throw new ie(e).$(n,t),e},r:function(e){ge(e,!c,1,!u),j.fa()},e:function(e){w?postMessage({cmd:"cleanupThread",thread:e}):ee(e)},o:ce,p:function(){return 2097152},q:function(e,n,t,r){if(e==n)setTimeout(()=>fe(r));else if(w)postMessage({targetThread:e,cmd:"processProxyingQueue",queue:r});else{if(!(e=j.V[e]))return;e.postMessage({cmd:"processProxyingQueue",queue:r})}return 1},t:function(){return-1},m:function(){throw 1/0},b:function(){k("")},f:function(){var e;f||c||((se=se||{})[e="Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread"]||(se[e]=1,g(e=f?"warning: "+e:e)))},c:D,h:function(e,n,t){V.copyWithin(e,n,n+t)},s:function(e,n,t){le.length=n,t>>=3;for(var r=0;r<n;r++)le[r]=X[t+r];return(e<0?K[-e-1]:_e[e]).apply(null,le)},n:function(){k("OOM")},g:function(){throw"unwind"},k:re,u:pe,l:de,d:he,j:function(e,n,t){var r=U();try{return oe(e)(n,t)}catch(e){if(q(r),e!==e+0)throw e;Se(1,0)}},i:function(e,n,t){var r=U();try{oe(e)(n,t)}catch(e){if(q(r),e!==e+0)throw e;Se(1,0)}},a:y||o.wasmMemory},we=(!function(){function n(e,n){var t;o.asm=e.exports,j.ga.push(o.asm.G),Y=o.asm.D,Z.unshift(o.asm.x),H=n,w||(t=j.W.length,j.W.forEach(function(e){j.ba(e,function(){var e;!--t&&(S--,o.monitorRunDependencies&&o.monitorRunDependencies(S),0==S&&(null!==G&&(clearInterval(G),G=null),T))&&(e=T,T=null,e())})}))}function t(e){n(e.instance,e.module)}function r(e){return function(){if(!d&&(u||c)){if("function"==typeof fetch&&!A.startsWith("file://"))return fetch(A,{credentials:"same-origin"}).then(function(e){if(e.ok)return e.arrayBuffer();throw"failed to load wasm binary file at \'"+A+"\'"}).catch($);if(s)return new Promise(function(n,e){s(A,function(e){n(new Uint8Array(e))},e)})}return Promise.resolve().then($)}().then(function(e){return WebAssembly.instantiate(e,a)}).then(function(e){return e}).then(e,function(e){g("failed to asynchronously prepare wasm: "+e),k(e)})}var a={a:ye};if(w||(S++,o.monitorRunDependencies&&o.monitorRunDependencies(S)),o.instantiateWasm)try{return o.instantiateWasm(a,n)}catch(e){g("Module.instantiateWasm callback failed with error: "+e),i(e)}(d||"function"!=typeof WebAssembly.instantiateStreaming||Q()||A.startsWith("file://")||f||"function"!=typeof fetch?r(t):fetch(A,{credentials:"same-origin"}).then(function(e){return WebAssembly.instantiateStreaming(e,a).then(t,function(e){return g("wasm streaming compile failed: "+e),g("falling back to ArrayBuffer instantiation"),r(t)})})).catch(i)}(),o.___wasm_call_ctors=function(){return(o.___wasm_call_ctors=o.asm.x).apply(null,arguments)},o._jxlCreateInstance=function(){return(o._jxlCreateInstance=o.asm.y).apply(null,arguments)},o._jxlDestroyInstance=function(){return(o._jxlDestroyInstance=o.asm.z).apply(null,arguments)},o._jxlProcessInput=function(){return(o._jxlProcessInput=o.asm.A).apply(null,arguments)},o._malloc=function(){return(we=o._malloc=o.asm.B).apply(null,arguments)}),P=(o._jxlFlush=function(){return(o._jxlFlush=o.asm.C).apply(null,arguments)},o._jxlDecompress=function(){return(o._jxlDecompress=o.asm.E).apply(null,arguments)},o._jxlCleanup=function(){return(o._jxlCleanup=o.asm.F).apply(null,arguments)},o.__emscripten_tls_init=function(){return(o.__emscripten_tls_init=o.asm.G).apply(null,arguments)},o._pthread_self=function(){return(P=o._pthread_self=o.asm.H).apply(null,arguments)}),ge=o.__emscripten_thread_init=function(){return(ge=o.__emscripten_thread_init=o.asm.I).apply(null,arguments)},ve=(o.__emscripten_thread_crashed=function(){return(o.__emscripten_thread_crashed=o.asm.J).apply(null,arguments)},o._emscripten_run_in_main_runtime_thread_js=function(){return(ve=o._emscripten_run_in_main_runtime_thread_js=o.asm.K).apply(null,arguments)}),be=o.__emscripten_proxy_execute_task_queue=function(){return(be=o.__emscripten_proxy_execute_task_queue=o.asm.L).apply(null,arguments)},xe=o.__emscripten_thread_free_data=function(){return(xe=o.__emscripten_thread_free_data=o.asm.M).apply(null,arguments)},Ae=o.__emscripten_thread_exit=function(){return(Ae=o.__emscripten_thread_exit=o.asm.N).apply(null,arguments)},Se=o._setThrew=function(){return(Se=o._setThrew=o.asm.O).apply(null,arguments)},Te=o._emscripten_stack_set_limits=function(){return(Te=o._emscripten_stack_set_limits=o.asm.P).apply(null,arguments)},U=o.stackSave=function(){return(U=o.stackSave=o.asm.Q).apply(null,arguments)},q=o.stackRestore=function(){return(q=o.stackRestore=o.asm.R).apply(null,arguments)},ke=o.stackAlloc=function(){return(ke=o.stackAlloc=o.asm.S).apply(null,arguments)};function Me(){function e(){if(!W&&(W=!0,o.calledRun=!0,!N)&&(w||E(Z),t(o),o.onRuntimeInitialized&&o.onRuntimeInitialized(),!w)){if(o.postRun)for("function"==typeof o.postRun&&(o.postRun=[o.postRun]);o.postRun.length;){var e=o.postRun.shift();z.unshift(e)}E(z)}}if(!(0<S))if(w)t(o),w||E(Z),postMessage({cmd:"loaded"});else{if(o.preRun)for("function"==typeof o.preRun&&(o.preRun=[o.preRun]);o.preRun.length;)n=void 0,n=o.preRun.shift(),J.unshift(n);E(J),0<S||(o.setStatus?(o.setStatus("Running..."),setTimeout(function(){setTimeout(function(){o.setStatus("")},1),e()},1)):e())}var n}if(o.___cxa_is_pointer_type=function(){return(o.___cxa_is_pointer_type=o.asm.T).apply(null,arguments)},o.keepRuntimeAlive=function(){return _},o.wasmMemory=y,o.ExitStatus=M,o.PThread=j,T=function e(){W||Me(),W||(T=e)},o.preInit)for("function"==typeof o.preInit&&(o.preInit=[o.preInit]);0<o.preInit.length;)o.preInit.pop()();return Me(),e.ready}})();"object"==typeof exports&&"object"==typeof module?module.exports=JxlDecoderModule:"function"==typeof define&&define.amd?define([],function(){return JxlDecoderModule}):"object"==typeof exports&&(exports.JxlDecoderModule=JxlDecoderModule);',
