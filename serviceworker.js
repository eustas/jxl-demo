...
(() => {
  ...
  const EMBEDDED = {
    'client_worker.js': 'let decoder=null,jobs=[];const processJobs=()=>{for(;;){let e=null;for(let o=0;o<jobs.length;++o)if(jobs[o].inputComplete){e=jobs[o],jobs[o]=jobs[jobs.length-1],jobs.pop();break}if(!e)return;console.log("CW job: "+e.uid);var s=e.input;let t=0;for(let o=0;o<s.length;o++)t+=s[o].length;const n=new Uint8Array(t);let l=0;for(let o=0;o<s.length;++o)n.set(s[o],l),l+=s[o].length;var o={uid:e.uid,data:buffer};postMessage(o,[n.buffer])}},onLoadJxlModule=(onmessage=function(o){var t=o.data;if(console.log("CW received: "+t.op),"decodeJxl"===t.op){let e=null;for(let o=0;o<jobs.length;++o)if(jobs[o].uid===t.uid){e=jobs[o];break}e||(e={uid:t.uid,input:[],inputComplete:!1},jobs.push(e)),t.data?e.input.push(t.data):e.inputComplete=!0,processJobs()}},o=>{decoder=o,processJobs()}),config=(importScripts("jxl_decoder.js"),{mainScriptUrlOrBlob:"https://jxl-demo.netlify.app/jxl_decoder.js"});JxlCodecModule(config).then(onLoadJxlModule);',
