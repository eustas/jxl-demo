...
(() => {
  ...
  const EMBEDDED = {
    'client_worker.js': 'let decoder=null,jobs=[];const processJobs=()=>{for(;;){let e=null;for(let o=0;o<jobs.length;++o)if(jobs[o].inputComplete){e=jobs[o],jobs[o]=jobs[jobs.length-1],jobs.pop();break}if(!e)return;console.log("CW job: "+e.uid);var n=e.input;let l=0;for(let o=0;o<n.length;o++)l+=n[o].length;let t=new Uint8Array(l),s=0;for(let o=0;o<n.length;++o)t.set(n[o],s),s+=n[o].length;var o={uid:e.uid,data:t};postMessage(o)}},onLoadJxlModule=(onmessage=function(o){var l=o.data;if(console.log("CW received: "+l.op),"decodeJxl"===l.op){let e=null;for(let o=0;o<jobs.length;++o)if(jobs[o].uid===l.uid){e=jobs[o];break}e||(e={uid:l.uid,input:[],inputComplete:!1},jobs.push(e)),l.data?e.input.push(l.data):e.inputComplete=!0,processJobs()}},o=>{decoder=o,processJobs()}),config=(importScripts("jxl_decoder.js"),{mainScriptUrlOrBlob:"https://jxl-demo.netlify.app/jxl_decoder.js"});JxlCodecModule(config).then(onLoadJxlModule);',
